...
func (x *PeerClientMessage) GetRouting() *RoutingMessage {
	if x, ok := x.GetMessage().(*PeerClientMessage_Routing); ok {
		return x.Routing
	}
	return nil
}
...
type PeerClientMessage_Routing struct {
	Routing *RoutingMessage `protobuf:"bytes,10,opt,name=routing,proto3,oneof"`
}
...
func (*PeerClientMessage_Routing) isPeerClientMessage_Message() {}
...
func (x *PeerServerMessage) GetRouting() *RoutingMessage {
	if x, ok := x.GetMessage().(*PeerServerMessage_Routing); ok {
		return x.Routing
	}
	return nil
}
...
type PeerServerMessage_Routing struct {
	Routing *RoutingMessage `protobuf:"bytes,10,opt,name=routing,proto3,oneof"`
}
...
func (*PeerServerMessage_Routing) isPeerServerMessage_Message() {}
...
type PeerMessage_HttpRequestStart struct {
	HttpRequestStart *HttpRequestStart `protobuf:"bytes,20,opt,name=http_request_start,json=httpRequestStart,proto3,oneof"`
}

type PeerMessage_HttpRequestBody struct {
	HttpRequestBody *HttpRequestBody `protobuf:"bytes,21,opt,name=http_request_body,json=httpRequestBody,proto3,oneof"`
}

type PeerMessage_HttpRequestEnd struct {
	HttpRequestEnd *HttpRequestEnd `protobuf:"bytes,22,opt,name=http_request_end,json=httpRequestEnd,proto3,oneof"`
}

type PeerMessage_HttpResponseStart struct {
	HttpResponseStart *HttpResponseStart `protobuf:"bytes,30,opt,name=http_response_start,json=httpResponseStart,proto3,oneof"`
}

type PeerMessage_HttpResponseBody struct {
	HttpResponseBody *HttpResponseBody `protobuf:"bytes,31,opt,name=http_response_body,json=httpResponseBody,proto3,oneof"`
}

type PeerMessage_HttpResponseEnd struct {
	HttpResponseEnd *HttpResponseEnd `protobuf:"bytes,32,opt,name=http_response_end,json=httpResponseEnd,proto3,oneof"`
}
...
var file_peering_proto_peering_proto_rawDesc = []byte{
	...
	0x64, 0x73, 0x68, 0x61, 0x6b, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x1b, 0x70, 0x65,
	0x65, 0x72, 0x69, 0x6e, 0x67, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x72, 0x6f, 0x75, 0x74,
	0x69, 0x6e, 0x67, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xef, 0x01, 0x0a, 0x11, 0x50, 0x65,
	...
	,
...
var file_peering_proto_peering_proto_goTypes = []interface{}{
	...
	(*RoutingMessage)(nil),    // 9: RoutingMessage
	(*ServerHello)(nil),       // 10: ServerHello
	(*HttpRequestStart)(nil),  // 11: HttpRequestStart
	(*HttpRequestBody)(nil),   // 12: HttpRequestBody
	(*HttpRequestEnd)(nil),    // 13: HttpRequestEnd
	(*HttpResponseStart)(nil), // 14: HttpResponseStart
	(*HttpResponseBody)(nil),  // 15: HttpResponseBody
	(*HttpResponseEnd)(nil),   // 16: HttpResponseEnd
}
var file_peering_proto_peering_proto_depIdxs = []int32{
	...
	9,  // 3: test.PeerClientMessage.routing:type_name -> RoutingMessage
	4,  // 4: test.PeerServerMessage.peer_message:type_name -> test.PeerMessage
	10, // 5: test.PeerServerMessage.server_hello:type_name -> ServerHello
	3,  // 6: test.PeerServerMessage.close_by_server:type_name -> test.PeerCloseByServer
	9,  // 7: test.PeerServerMessage.routing:type_name -> RoutingMessage
	0,  // 8: test.PeerCloseByServer.reason:type_name -> test.CloseByServerReason
	5,  // 9: test.PeerMessage.ping:type_name -> test.Ping
	6,  // 10: test.PeerMessage.pong:type_name -> test.Pong
	11, // 11: test.PeerMessage.http_request_start:type_name -> HttpRequestStart
	12, // 12: test.PeerMessage.http_request_body:type_name -> HttpRequestBody
	13, // 13: test.PeerMessage.http_request_end:type_name -> HttpRequestEnd
	14, // 14: test.PeerMessage.http_response_start:type_name -> HttpResponseStart
	15, // 15: test.PeerMessage.http_response_body:type_name -> HttpResponseBody
	16, // 16: test.PeerMessage.http_response_end:type_name -> HttpResponseEnd
	1,  // 17: test.Peering.Peer:input_type -> test.PeerClientMessage
	2,  // 18: test.Peering.Peer:output_type -> test.PeerServerMessage
...
func file_peering_proto_peering_proto_init() {
	...
	file_peering_proto_routing_proto_init()
	if !protoimpl.UnsafeEnabled {
